...
?><p id="sbDesc"><?php _e( 'On this page you can set up different tax rates to use throughout your CRM (e.g. in invoices).', 'zero-bs-crm' ); ?></p>
...
<div id="sbA">
    ...
    <script type="text/javascript">
        ...
        var zeroBSCRMJS_taxTableLang = {
            ...
            defaultTaxName: '<?php echo zeroBSCRM_slashOut(__('Tax Rate Name','zero-bs-crm')); ?>',
            defaultTaxPerc: '<?php echo zeroBSCRM_slashOut(__('Tax Rate %','zero-bs-crm')); ?>',
        ...
        function zeroBSCRMJS_bind_taxTables(){
            ...
            jQuery('.zbs-taxtable-remove-rate').off('click').on( 'click', function(){
                ...
                swal({
                    title: '<?php echo zeroBSCRM_slashOut( __( 'Are you sure?', 'zero-bs-crm' ) ); ?>',
                    text: '<?php echo zeroBSCRM_slashOut( __( 'Are you sure you want to delete this tax rate? This will remove it from your database and existing transactions with this tax rate will not show properly. You cannot undo this.', 'zero-bs-crm' ) ); ?>',
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    confirmButtonText: '<?php echo zeroBSCRM_slashOut( __( 'Yes, remove the tax rate.', 'zero-bs-crm' ) ); ?>',
                })//.then((result) => {
