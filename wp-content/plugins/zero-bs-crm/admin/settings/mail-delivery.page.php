    ...
    ?><div id="zbs-mail-delivery-wizard-wrap" class="hidden">
        ...
        <div class="ui three top attached steps">
            ...
            <div class="disabled step zbs-top-step-2">
                ...
                <div class="content">
                    ...
                    <div class="description"><?php _e('Your Mail Server Settings',"zero-bs-crm"); ?></div>
                </div>
            </div>
        ...
        <div class="ui attached segment borderless" id="zbs-mail-delivery-wizard-steps-wrap">
            ...
            <div id="zbs-mail-delivery-wizard-step-2-wrap" class="hidden zbs-step">
                ...
                <div class="ui very padded segment borderless">
                    <p>
                        <?php _e( 'The CRM can send out emails via your default server settings, API, or via an SMTP server (mail server). If you would like to reliably send emails from a custom domain, we recommend using SMTP or an API connection.', 'zero-bs-crm' ); ?>
                        <?php ##WLREMOVE ?>
                        <a href="<?php echo $zbs->urls['kbsmtpsetup']; ?>"><?php _e('See the Guide',"zero-bs-crm"); ?></a>
                        <?php ##/WLREMOVE ?>
                    </p>
                    ...
                    <div class="ui form">
                            ...
                            <div class="five wide column">
                                ...
                                <div class="field">
                                    <div class="ui radio checkbox" id="jpcrm-mail-delivery-wizard-step-2-servertype-oauth">
                                        ...
                                        <label><?php _e('API (OAuth)',"zero-bs-crm"); ?></label>
                                    </div>
                                </div>
                        ...
                        <?php
                            ...
                            if ( $zbs->oauth->enabled() ){
                                ...
                                $oauth_settings_page_url = esc_url( zbsLink( $zbs->slugs['settings'] . '&tab=oauth') );
                            ...
                            <div class="hidden" id="jpcrm-mail-delivery-wizard-step-2-api" style="padding:1em">
                                <div class="field">
                                    <label for="oauth_connections"><?php echo sprintf( __( 'Select <a href="%s" target="_blank">OAuth Connection</a>', "zero-bs-crm" ), $oauth_settings_page_url ); ?></label>
                                    <select id="oauth_connections">
                                        <?php 
                                            ...
                                            if ( count( $oauth_available_providers ) > 0 ){
                                                ...
                                                ?><option value="-1" selected="selected" disabled="disabled"><?php _e('Select an OAuth Connection',"zero-bs-crm"); ?></option>
                                                ...
                                                <?php foreach ( $oauth_available_providers as $oauth_profile_key => $oauth_profile){
                                                    ...
                                                    echo '<option value="' . $oauth_profile_key . '">' . $oauth_profile['provider']['name'] . $oauth_profile_detail . '</option>';
                                                ...
                                                ?><option value="-1" selected="selected" disabled="disabled"><?php _e( 'No active OAuth connections', "zero-bs-crm" ); ?></option><?php
                        ...
                        <?php } else {
                            ...
                            ?><div class="hidden" id="jpcrm-mail-delivery-wizard-step-2-api" style="padding:1em">
                                <div class="field">
                                    <?php echo sprintf( __( 'Currently your system does not support OAuth API connections. <a href="%s" target="_blank">Read More</a>', 'zero-bs-crm' ), $zbs->urls['kb-oauth-requirements'] ); ?>
