                ...
                <div class="ui bottom attached tab segment" data-tab="files">
                  ...
                  if ( current_user_can('admin_zerobs_manage_options') && !defined('ZBS_CLIENTPRO_TEMPLATES') ){
                    ...
                    if ( !$zbs->hasEntrepreneurBundleMin() ){
                      ...
                      echo sprintf( __( 'Want to show client files on their Client Portal? <a href="%s" target="_blank">Upgrade to a Bundle</a> (and get Client Portal Pro) to enable this.', 'zero-bs-crm' ), $zbs->urls['upgrade'] . '?utm_content=inplugin-contactview' );
