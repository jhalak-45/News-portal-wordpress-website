...
(function() {
	...
	var template_placeholders =  [{text:'Contact Full Name',value:'##CONTACT-FULLNAME##'},{text:'Contact First Name',value:'##CONTACT-FNAME##'},{text:'Contact Last Name',value:'##CONTACT-LNAME##'},{text:'Contact Email',value:'##CONTACT-EMAIL##'},{text:'Business Name',value:'##BIZ-NAME##'},{text:'Business State/Region',value:'##BIZSTATE##'},{text:'Quote Title',value:'##QUOTE-TITLE##'},{text:'Quote Value',value:'##QUOTEVALUE##'},{text:'Quote Date',value:'##QUOTEDATE##'}];
