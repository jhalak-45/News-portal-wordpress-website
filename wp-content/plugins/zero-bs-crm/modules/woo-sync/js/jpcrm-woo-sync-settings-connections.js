...
function jpcrm_woosync_bind_add_connection(){
	...
	jQuery('#jpcrm-woosync-connect-to-store').on('click', function(){
		...
		var swal_HTML = '<div style="font-size: 1.2em;padding: 0.3em;">'
		+ zeroBSCRMJS_globViewLang( 'connect-woo-site-url' ) + '<br />'
		+ '<div class="ui input" style="width: 350px;"><input type="text" name="jpcrm-connect-woocommerce-store-url" id="jpcrm-connect-woocommerce-store-url" value="" placeholder="' + zeroBSCRMJS_globViewLang( 'connect-woo-site-placeholder' )+ '" /></div>'
		+ '<div class="jpcrm-woosync-add-connection-errors">'
		+ '<div class="ui hidden pointing red basic label" id="jpcrm-woosync-connect-to-store-invalid-url-empty">' + zeroBSCRMJS_globViewLang( 'connect-woo-invalid-url-empty' ) + '</div>'
		+ '<div class="ui hidden pointing red basic label" id="jpcrm-woosync-connect-to-store-invalid-url">' + zeroBSCRMJS_globViewLang( 'connect-woo-invalid-url-detail' ) + '</div>'
		+ '<div class="ui hidden pointing red basic label" id="jpcrm-woosync-connect-to-store-invalid-url-http">' + zeroBSCRMJS_globViewLang( 'connect-woo-invalid-url-http' ) + '</div>'
		+ '<div class="ui hidden pointing red basic label" id="jpcrm-woosync-connect-to-store-invalid-url-duplicate">' + zeroBSCRMJS_globViewLang( 'connect-woo-invalid-url-duplicate' ) + '</div>'
		+ '<div class="ui hidden pointing red basic label" id="jpcrm-woosync-connect-to-store-ajax-error">' + zeroBSCRMJS_globViewLang( 'connect-woo-ajax-error' ) + '</div>'
		+ '</div>'
		+ '</div>';
		...
		swal({
			...
			preConfirm: function () {
				...
				// get value
				var site_url = jpcrm_strip_trailing_slashes( jQuery( '#jpcrm-connect-woocommerce-store-url' ).val() );
				...
				return new Promise(function (resolve, reject) {
					...
					else if ( window.zbs_root.woosync_connections && window.zbs_root.woosync_connections.indexOf( site_url ) >= 0 ){

						// error, show notice
						jQuery( '#jpcrm-woosync-connect-to-store-invalid-url-duplicate' ).removeClass( 'hidden' );
						reject();
						return false;
