...
class Client_Portal {
	...
	function init() {
		...
		// Fixes a conflict with the aiseo shortcode (more info: gh-1753).
		add_filter( 'aioseo_conflicting_shortcodes', array( $this, 'aioseo_conflicting_shortcode_fix' ) );
	...
	*/
	...
	/**
	 * This function makes sure our shortcode renders in the correct place in the theme and not above the header 
	 * which is the case if include_once fix only was applied.
	 */
	function aioseo_conflicting_shortcode_fix( $conflicting_shortcodes ) {
		$conflicting_shortcodes = array_merge( $conflicting_shortcodes, [
